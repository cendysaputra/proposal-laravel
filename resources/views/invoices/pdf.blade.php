...
<head>
    ...
    <style>
        ...
        * {
        ...
        .items-table thead {
            background-color: {{ $invoice->brand === 'logobrand-2' ? '#000000' : '#004258' }};
        }
        ...
        .items-table tfoot {
            background-color: {{ $invoice->brand === 'logobrand-2' ? '#E5E7EB' : '#CCE9ED' }};
        }
        ...
        .footer h3 {
            font-size: {{ 15 * $s }}px;
            font-weight: bold;
            color: {{ $invoice->brand === 'logobrand-2' ? '#000000' : '#004258' }};
            margin-bottom: {{ 8 * $s }}px;
        }
