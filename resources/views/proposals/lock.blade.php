...
<head>
    ...
    <title>Proposal Terkunci - {{ $proposal->title }}</title>
        ...
        <div class="max-w-md w-full">
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="px-8 py-6">
                    <!-- Proposal Info -->
                    <div class="mb-6">
                        <h3 class="text-[24px] text-center font-semibold text-gray-700 mb-2">{{ $proposal->client_name }}</h3>
                        <p class="text-sm text-center text-gray-600 font-mono">{{ $proposal->proposal_number }}</p>
                    </div>
                    ...
                    <!-- Login Form -->
                    <form action="{{ route('proposals.unlock', $proposal->slug) }}" method="POST" class="space-y-4">
                        @csrf
